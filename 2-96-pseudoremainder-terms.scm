...
(define p1 (make-polynomial 'x (make-sparse-terms '((1 2) (-2 1) (1 0)))))
(define p2 (make-polynomial 'x (make-sparse-terms '((11 2) (7 0)))))
(define p3 (make-polynomial 'x (make-sparse-terms '((13 1) (5 0)))))
(define q1 (mul p1 p2))
(define q2 (mul p1 p3))
