  ...
  (define (reorder-poly poly old-var new-var)
    ...
    (define (convert-term term)
      (let ((term-coeff (coeff term))
        ...
        (if (eq? (type-tag term-coeff) 'polynomial)
            (let*
...
(define coeff1 (make-polynomial 'x (make-sparse-terms '((1 3) (1 1) (9 0)))))
(define coeff2 (make-polynomial 'x (make-sparse-terms '((1 2) (1 1) (7 0)))))
(define coeff3 (make-polynomial 'x (make-sparse-terms '((1 1)))))
(define poly (make-polynomial 'y (make-sparse-terms  (list (list coeff1 3) (list coeff2 2) (list coeff3 1)))))
