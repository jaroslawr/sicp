...
;; - The cat is with the student in the class
;;
;; (sentence
;;  (simple-noun-phrase (article the) (noun professor))
;;  (verb-phrase
...
;; - The professor lectures to the student
;; - The student is in the class
;; - The student has a cat with him
;;
;; (sentence
;;  (simple-noun-phrase (article the) (noun professor))
;;  (verb-phrase (verb lectures)
...
;; - The professor lectures to the student who has a cat with him
