...
(<
 (abs (-
       (percent-of-product (make-center-percent 100 0.5) (make-center-percent 100 0.5))
       (percent (mul-interval (make-center-percent 100 0.5) (make-center-percent 100 0.5)))))
 0.0001)
