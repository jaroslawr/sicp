;;; Scan-out-defines was installed in procedure-body, because the
;;; procedures being part of the procedure abstraction may need to
;;; access the original body also - for example for debugging
;;; purposes. This has the disadvantage that the procedure
;;; scan-out-defines may be called many times - this could be work
;;; arounded by adding one more "field" in make-procedure.
...
;;; If unless was a procedure, then in a normal-order evaluation
;;; language you could have three lists with conditions, consequents
;;; and alternatives and use map to iterate through them with unless.
;;; For example:
;;;
;;; (map unless (list (= 5 5)       (= 5 7)       (= 3 3))
;;;             (list (display "x") (display "y") (display "z"))
;;;             (list (display "a") (display "b") (display "c")))
;;;
;;; Would display:
;;;
;;; xbz
