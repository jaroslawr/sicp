                ...
                (if (not (eq? type1 type2))
                    (let ((t1->t2 (get-coercion type1 type2))
                      ...
                      (cond (t1->t2 (apply-generic op (t1->t2 a1) a2))
                            ...
                            (else
                             (error "No method for such argument types" (list op type-tags)))))
                    (error "No method for such argument types" (list op type-tags))))
              (error "No method for arg types -- APPLY-GENERIC" (list op type-tags)))))))
